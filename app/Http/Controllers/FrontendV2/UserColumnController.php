...
use App\Http\RequestsV2\UserColumnRequest;
use App\ServicesV2\UserService;
use App\ServicesV2\UserColumnService;
 ...
 */
class UserColumnController extends BaseController
{
    use ApiResponse;

    protected $service;

    public function __construct(UserColumnService $service)
    {
